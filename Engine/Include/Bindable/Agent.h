...
namespace Engine
{
    ...
    {
    public:
        Agent(std::shared_ptr<class TransformBuffer> pTransform, class NavMesh* pNavMesh, const Vector3& pos);
    ...
    public:
        ...
        void SetTransform(std::shared_ptr<TransformBuffer> pTransform);
